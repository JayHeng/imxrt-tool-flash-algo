...
WEAK void HW_WAKE_IRQHandler(void);
...
WEAK void I3C_IRQHandler(void);
WEAK void USB0_IRQHandler(void);
WEAK void USB0_WAKEUP_IRQHandler(void);
...
void HW_WAKE_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void I3C_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void USB0_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void USB0_WAKEUP_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void (* const g_pfnVectors[])(void) = {
    ...
    HW_WAKE_IRQHandler,          // 42: Hardware wake-up
    ...
    QSPI_IRQHandler,             // 58: Quad/Octal SPI interface
    ...
    I3C_IRQHandler,              // 65: I3C interface 0
    USB0_IRQHandler,             // 66: High-speed USB device/host
    USB0_WAKEUP_IRQHandler,      // 67: USB Activity Wake-up Interrupt
    WDT1_IRQHandler,             // 68: Windowed watchdog timer 1 (HiFi 4 watchdog)
    USB_PHYDCD_IRQHandler,       // 69: USBPHY DCD
    ...
    PMC_IRQHandler,              // 74: Power management IC
