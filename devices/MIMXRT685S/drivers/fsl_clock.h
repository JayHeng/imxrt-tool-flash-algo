...
#define OSPIFCLKSEL_OFFSET 0x620
...
typedef enum _clock_attach_id
{
    ...
    kMAIN_CLK_to_QSPI_CLK = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 0),
    kMAIN_PLL_to_QSPI_CLK = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 1),
    kAUX0_PLL_to_QSPI_CLK = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 2),
    kFFRO_to_QSPI_CLK     = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 3),
    kAUX1_PLL_to_QSPI_CLK = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 4),
    kNONE_to_QSPI_CLK     = CLKCTL0_TUPLE_MUXA(OSPIFCLKSEL_OFFSET, 7),
