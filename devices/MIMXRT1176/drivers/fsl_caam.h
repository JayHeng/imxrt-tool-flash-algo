...
/*! @name Driver version */
/*@{*/
/*! @brief CAAM driver version. Version 2.0.2.
 *
 ...
 * - Version 2.0.2
 *   - Disable Common subexpression elimination for IAR in caam_in_job_ring_add()
 *     function due to issue with descriptor address.
 */
#define FSL_CAAM_DRIVER_VERSION (MAKE_VERSION(2, 0, 2))
/*@}*/
