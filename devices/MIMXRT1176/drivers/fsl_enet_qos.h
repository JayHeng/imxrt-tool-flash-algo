...
#define FSL_ENET_QOS_DRIVER_VERSION (MAKE_VERSION(2, 0, 0)) /*!< Version 2.0.0. */
/*@}*/

/*! @name Control and status region bit masks of the receive buffer descriptor. */
/*@{*/
/*! @brief Defines for read format. */
#define ENET_QOS_RXDESCRIP_RD_BUFF1VALID_MASK (1U << 24) /*!< Buffer1 address valid. */
#define ENET_QOS_RXDESCRIP_RD_BUFF2VALID_MASK (1U << 25) /*!< Buffer2 address valid. */
#define ENET_QOS_RXDESCRIP_RD_IOC_MASK (1U << 30)        /*!< Interrupt enable on complete. */
#define ENET_QOS_RXDESCRIP_RD_OWN_MASK (1U << 31)        /*!< Own bit. */

/*! @brief Defines for write back format. */
#define ENET_QOS_RXDESCRIP_WR_ERR_MASK ((1U << 3) | (1U << 7))
#define ENET_QOS_RXDESCRIP_WR_PYLOAD_MASK (0x7U)
#define ENET_QOS_RXDESCRIP_WR_PTPMSGTYPE_MASK (0xF00U)
#define ENET_QOS_RXDESCRIP_WR_PTPTYPE_MASK (1U << 12)
#define ENET_QOS_RXDESCRIP_WR_PTPVERSION_MASK (1U << 13)
#define ENET_QOS_RXDESCRIP_WR_PTPTSA_MASK (1U << 14)
#define ENET_QOS_RXDESCRIP_WR_PACKETLEN_MASK (0x7FFFU)
#define ENET_QOS_RXDESCRIP_WR_ERRSUM_MASK (1U << 15)
#define ENET_QOS_RXDESCRIP_WR_TYPE_MASK (0x30000U)
#define ENET_QOS_RXDESCRIP_WR_DE_MASK (1U << 19)
#define ENET_QOS_RXDESCRIP_WR_RE_MASK (1U << 20)
#define ENET_QOS_RXDESCRIP_WR_OE_MASK (1U << 21)
#define ENET_QOS_RXDESCRIP_WR_RS0V_MASK (1U << 25)
#define ENET_QOS_RXDESCRIP_WR_RS1V_MASK (1U << 26)
#define ENET_QOS_RXDESCRIP_WR_RS2V_MASK (1U << 27)
#define ENET_QOS_RXDESCRIP_WR_LD_MASK (1U << 28)
#define ENET_QOS_RXDESCRIP_WR_FD_MASK (1U << 29)
#define ENET_QOS_RXDESCRIP_WR_CTXT_MASK (1U << 30)
#define ENET_QOS_RXDESCRIP_WR_OWN_MASK (1U << 31)
/*@}*/

/*! @name Control and status bit masks of the transmit buffer descriptor. */
/*@{*/
/*! @brief Defines for read format. */
#define ENET_QOS_TXDESCRIP_RD_BL1_MASK (0x3fffU)
#define ENET_QOS_TXDESCRIP_RD_BL2_MASK (ENET_QOS_TXDESCRIP_RD_BL1_MASK << 16)
...
#define ENET_QOS_TXDESCRIP_RD_TTSE_MASK (1U << 30)
#define ENET_QOS_TXDESCRIP_RD_IOC_MASK (1U << 31)

#define ENET_QOS_TXDESCRIP_RD_FL_MASK (0x7FFFU)
#define ENET_QOS_TXDESCRIP_RD_FL(n) ((uint32_t)(n)&ENET_QOS_TXDESCRIP_RD_FL_MASK)
#define ENET_QOS_TXDESCRIP_RD_CIC(n) (((uint32_t)(n)&0x3) << 16)
#define ENET_QOS_TXDESCRIP_RD_TSE_MASK (1U << 18)
#define ENET_QOS_TXDESCRIP_RD_SLOT(n) (((uint32_t)(n)&0x0f) << 19)
#define ENET_QOS_TXDESCRIP_RD_SAIC(n) (((uint32_t)(n)&0x07) << 23)
#define ENET_QOS_TXDESCRIP_RD_CPC(n) (((uint32_t)(n)&0x03) << 26)
#define ENET_QOS_TXDESCRIP_RD_LDFD(n) (((uint32_t)(n)&0x03) << 28)
#define ENET_QOS_TXDESCRIP_RD_LD_MASK (1U << 28)
#define ENET_QOS_TXDESCRIP_RD_FD_MASK (1U << 29)
#define ENET_QOS_TXDESCRIP_RD_CTXT_MASK (1U << 30)
#define ENET_QOS_TXDESCRIP_RD_OWN_MASK (1UL << 31)

/*! @brief Defines for write back format. */
#define ENET_QOS_TXDESCRIP_WB_TTSS_MASK (1UL << 17)
/*@}*/
...
enum _enet_qos_status
{
    ...
    kStatus_ENET_QOS_PtpTsRingFull  = MAKE_STATUS(kStatusGroup_ENET_QOS, 6U), /*!< Timestamp ring full. */
    kStatus_ENET_QOS_PtpTsRingEmpty = MAKE_STATUS(kStatusGroup_ENET_QOS, 7U), /*!< Timestamp ring empty. */

    kStatus_ENET_QOS_Est_SwListBusy =
        MAKE_STATUS(kStatusGroup_ENET_QOS, 8U), /*!< SW Gcl List not yet processed by HW. */
    kStatus_ENET_QOS_Est_SwListWriteAbort = MAKE_STATUS(kStatusGroup_ENET_QOS, 9), /*!< SW Gcl List write aborted .*/
    kStatus_ENET_QOS_Est_InvalidParameter =
        MAKE_STATUS(kStatusGroup_ENET_QOS, 10),                             /*!< Invalid parameter in Gcl List .*/
    kStatus_ENET_QOS_Est_BtrError = MAKE_STATUS(kStatusGroup_ENET_QOS, 11), /*!< Base Time Error when loading list.*/
    kStatus_ENET_QOS_TrgtBusy     = MAKE_STATUS(kStatusGroup_ENET_QOS, 12), /*!< Target time register busy.*/
    kStatus_ENET_QOS_Timeout      = MAKE_STATUS(kStatusGroup_ENET_QOS, 13), /*!< Target time register busy.*/
    kStatus_ENET_QOS_PpsBusy      = MAKE_STATUS(kStatusGroup_ENET_QOS, 14)  /*!< Pps command busy.*/
};
...
{
    kENET_QOS_PacketAVCPQ = 0x0, /* AV Untagged Control Packets Queue */
    kENET_QOS_PacketPTPQ,        /* PTP Packets Queue */
    kENET_QOS_PacketDCBCPQ,      /* DCB Control Packets Queue */
    kENET_QOS_PacketUPQ,         /* Untagged Packets Queue */
    kENET_QOS_PacketMCBCQ,       /* Multicast & Broadcast Packets Queue */
    kENET_QOS_PacketNoQ,         /* Not specific queue */
...
typedef struct _enet_qos_tx_dirty_struct
{
    uint32_t buffAddr; /*!< Buffer address */
} enet_qos_tx_dirty_struct_t;
...
typedef struct _enet_qos_ptp_time_data
{
    uint8_t version;                                 /*!< PTP version. */
    uint8_t sourcePortId[kENET_QOS_PtpSrcPortIdLen]; /*!< PTP source port ID. */
    uint16_t sequenceId;                             /*!< PTP sequence ID. */
    uint8_t messageType;                             /*!< PTP message type. */
    enet_qos_ptp_time_t timeStamp;                   /*!< PTP timestamp. */
} enet_qos_ptp_time_data_t;

/*! @brief Defines the ENET PTP ring buffer structure for the PTP message timestamp store.*/
typedef struct _enet_qos_ptp_time_data_ring
{
    uint32_t front;                      /*!< The first index of the ring. */
    uint32_t end;                        /*!< The end index of the ring. */
    uint32_t size;                       /*!< The size of the ring. */
    enet_qos_ptp_time_data_t *ptpTsData; /*!< PTP message data structure. */
} enet_qos_ptp_time_data_ring_t;
...
{
    uint8_t enable;                 /*!< Enable or disable EST */
...
typedef struct _enet_qos_buffer_config
{
    ...
    enet_qos_tx_dirty_struct_t *txDirtyStartAddr;  /*!< Start address of the dirty tx buffers. */
    ...
    enet_qos_ptp_time_data_t *rxPtpTsData;         /*!< The start address of 1588 receive timestamp buffers */
    enet_qos_ptp_time_data_t *txPtpTsData;         /*!< The start address of 1588 transmit timestamp buffers */
...
typedef struct _enet_qos_tx_bd_ring
{
    ...
    enet_qos_ptp_time_data_ring_t txPtpTsDataRing; /*!< Transmit PTP 1588 time stamp data ring buffer. */
...
{
    enet_qos_tx_dirty_struct_t *txDirtyBase; /*!< Dirty buffer descriptor base address pointer. */
...
typedef struct _enet_qos_rx_bd_ring
{
    ...
    enet_qos_ptp_time_data_ring_t rxPtpTsDataRing; /*!< Receive PTP 1588 time stamp data ring buffer. */
 ...
 * @param flag The flag of this tx descriptor, see "enet_qos_desc_flag" .
