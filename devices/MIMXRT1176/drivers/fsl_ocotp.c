...
#define OCOTP_STATUS_READ_DED_MASK                                                 \
    (OCOTP_HW_OCOTP_OUT_STATUS0_DED0_MASK | OCOTP_HW_OCOTP_OUT_STATUS0_DED1_MASK | \
     OCOTP_HW_OCOTP_OUT_STATUS0_DED2_MASK | OCOTP_HW_OCOTP_OUT_STATUS0_DED3_MASK)
#endif
...
#if defined(OCOTP_HW_OCOTP_OUT_STATUS0_DED_RELOAD_MASK)
    /* Clear reload error status. */
    base->HW_OCOTP_OUT_STATUS0_CLR = OCOTP_HW_OCOTP_OUT_STATUS0_DED_RELOAD_MASK;
#endif
...
#if defined(OCOTP_HW_OCOTP_OUT_STATUS0_DED_RELOAD_MASK)
    if ((base->HW_OCOTP_OUT_STATUS0 & OCOTP_HW_OCOTP_OUT_STATUS0_DED_RELOAD_MASK) != 0U)
    {
...
status_t OCOTP_ReadFuseShadowRegisterExt(OCOTP_Type *base, uint32_t address, uint32_t *data, uint8_t fuseWords)
{
    ...
    /* Clear error flags. */
    base->HW_OCOTP_OUT_STATUS0_CLR = OCOTP_STATUS_READ_DED_MASK;
#endif
...
#if defined(OCOTP_STATUS_READ_DED_MASK)
    if ((base->HW_OCOTP_OUT_STATUS0 & OCOTP_STATUS_READ_DED_MASK) != 0U)
    {
        status = kStatus_Fail;
    }
#endif
...
#if defined(FSL_FEATURE_OCOTP_HAS_STATUS) && FSL_FEATURE_OCOTP_HAS_STATUS
    /* Clear errors. */
    base->HW_OCOTP_OUT_STATUS0_CLR =
        (OCOTP_HW_OCOTP_OUT_STATUS0_PROGFAIL_MASK | OCOTP_HW_OCOTP_OUT_STATUS0_LOCKED_MASK);
#endif
...
#if defined(FSL_FEATURE_OCOTP_HAS_STATUS) && FSL_FEATURE_OCOTP_HAS_STATUS
    regStatus = base->HW_OCOTP_OUT_STATUS0;

    if ((regStatus & OCOTP_HW_OCOTP_OUT_STATUS0_PROGFAIL_MASK) != 0U)
    {
        status = kStatus_OCOTP_ProgramFail;
    }
    else if ((regStatus & OCOTP_HW_OCOTP_OUT_STATUS0_LOCKED_MASK) != 0U)
    {
