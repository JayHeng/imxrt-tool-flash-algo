...
/*!
 * @brief The operating mode fo the LDOs.
 */
...
{
    kPMU_LpsrAnaLdoOutputFrom1P77To1P83 = 0U, /*!< The output voltage from 1.77V to 1.83V */
    kPMU_LpsrAnaLdoOutputFrom1P72To1P77 = 1U, /*!< The output voltage from 1.72V to 1.77V */
    kPMU_LpsrAnaLdoOutputFrom1P82To1P88 = 2U, /*!< The output voltage from 1.82V to 1.88V */
...
enum _pmu_static_bandgap_power_down_option
{
    ...
    kPMU_PowerDownVoltageReferenceOutputOnly =
        1U << 1U, /*!< Power down only the reference output section of the bandgap. */
    kPMU_PowerDownBandgapVBGUPDetector =
        1U << 2U, /*!< Power down the VBGUP detector of the bandgap without affecting any additional functionality. */
};
...
/*!
 * The enumeration of the body_bias_well's voltage level in static mode.
 */
typedef enum _pmu_body_bias_well_voltage_level
{
    kPMU_BodyBiasWellRegulateTo0P5V = 0x0U, /*!< Body Bias Well regulate to 0.5V */
    kPMU_BodyBiasWellRegulateTo0P6V = 0x1U, /*!< Body Bias Well regulate to 0.6V */
    kPMU_BodyBiasWellRegulateTo0P7V = 0x2U, /*!< Body Bias Well regulate to 0.7V */
    kPMU_BodyBiasWellRegulateTo0P8V = 0x3U, /*!< Body Bias Well regulate to 0.8V */
    kPMU_BodyBiasWellRegulateTo0P9V = 0x4U, /*!< Body Bias Well regulate to 0.9V */
    kPMU_BodyBiasWellRegulateTo1P0V = 0x5U, /*!< Body Bias Well regulate to 1.0V */
    kPMU_BodyBiasWellRegulateTo1P1V = 0x6U, /*!< Body Bias Well regulate to 1.1V */
    kPMU_BodyBiasWellRegulateTo1P2V = 0x7U, /*!< Body Bias Well regulate to 1.2V */
    kPMU_BodyBiasWellRegulateTo1P3V = 0x8U, /*!< Body Bias Well regulate to 1.3V */
...
typedef struct _pmu_static_lpsr_ana_ldo_config
{
    ...
    bool enable2mALoad;                                       /*!< Enable/Disable 2mA load.
                                                                      true    -   Enable 2mA loading to prevent the overshoot.
                                                                      false   -   Disable 2mA loading. */
    bool enable4mALoad;                                       /*!< Enable/Disable 4mA load.
                                                                      true    -   Enable 4mA loading to prevent the big voltage drop.
                                                                      false   -   Disable 4mA load. */
    bool enable20uALoad;                                      /*!< Enable/Disable 20uA load.
                                                                      true    -   Enable 20uA loading to prevent the overshoot.
                                                                      false   -   Disable 20uA load. */
...
typedef struct _pmu_static_lpsr_dig_config
{
    bool enableStableDetect;                            /*!< Enable/Disable Stable Detect.
                                                                true    -   Enable Stable Detect.
                                                                false   -   Disable Stable Detect. */
...
typedef struct _pmu_snvs_dig_config
{
    ...
    bool enablePullDown;        /*!< Enable/Disable Pull down.
                                    true    -   Enable the feature of using 1M ohm resistor discharge the LDO output.
                                    false    -  Disable the feature of using 1M ohm resistor discharge the LDO output. */
...
{
    uint8_t powerDownOption; /*!< The OR'ed value of _pmu_static_bandgap_power_down_option. Please refer to @ref
                                _pmu_static_bandgap_power_down_option  */
    bool enableLowPowerMode; /*!< Turn on/off the Low power mode.
                                     true    -   Turn on the low power operation of the bandgap.
                                     false   -   Turn off the low power operation of the bandgap. */
...
/*!
 * @brief Ture on/off Bypass mode of the LPSR DIG LDO in Static/Software mode.
 *
 * @param base ANADIG_LDO_SNVS peripheral base address.
 * @param enable
 ...
 * @param voltageValue The voltage step to be set. See the enumeration @ref pmu_lpsr_dig_target_output_voltage_t.
 */
 ...
 * bandgap self bias. After powering up, it is need to wait for the bandgap to get stable and then disable Bandgap Self
 ...
 *
 * @param config. Pointer to the structure pmu_static_bandgap_config_t. Please refer to @ref
 * pmu_static_bandgap_config_t.
 */
void PMU_StaticBandgapInit(const pmu_static_bandgap_config_t *config);

/*!
 * @brief Controls the ON/OFF of the Bandgap in the certain setpoints with GPC mode.
 *
 * @param base PMU peripheral base address.
 * @param setpointMap The map of setpoints should be the OR'ed Value of _pmu_setpoint_map.
 * @param enable Turn on/off the Bandgap.
 *                  true    -   Turn on the Bandgap in the certain setpoints.
 *                  false   -   Turn off the Bandgap in the certain setpoints.
 */
...
/*!
 * @brief Controls the ON/OFF of the Bandgap's Standby mode in the certain setpoints with GPC mode.
 *
 * @param base PMU peripheral base address.
 * @param setpointMap The map of setpoints should be the OR'ed Value of _pmu_setpoint_map.
 * @param enable Turn on/off the Bandgap's Standby mode.
 *                  true    -   Turn on the Bandgap's Standby mode in the certain setpoints.
 *                  false   -   Turn off the Bandgap's Standby mode in the certain setpoints.
 */
