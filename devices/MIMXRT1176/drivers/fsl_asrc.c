                                   ...
                                   uint32_t outSampleRate)
{
    ...
    /* clear the pre/post processing to use automatically update option*/
    base->ASRCFG &= ~(ASRC_ASRCFG_PRE_MODE_MASK(channelPair) | ASRC_ASRCFG_POST_MODE_MASK(channelPair));
    base->ASRCTR = asrctr;
