...
/* placeholder for rpmsg shared memory */
  ...
  noCache_seg :                       	org = 0x00BFD000, len = 0x3000
}
...
_memmap_seg_dram0_0_max   = 0xbfb000;
_memmap_seg_dram0_1_start = 0xbfb000;
_memmap_seg_dram0_1_max   = 0xbfd000;
_memmap_seg_noCache_start = 0xbfd000;
_memmap_seg_noCache_max   = 0xc00000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xbfb000);
  _heap_sentry = 0xbfb000;
