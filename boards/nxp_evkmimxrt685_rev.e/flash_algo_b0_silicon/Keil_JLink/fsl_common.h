...
#ifndef ALIGN_TO_PAGESIZE
#define ALIGN_TO_PAGESIZE(x, a) (((x) + (a)-1) / (a) * (a))
#endif
...
enum _status_groups
{
    ...
    kStatusGroup_FLEXSPI = 60,                /*!< Group number for FLEXSPI status codes. */
    ...
    kStatusGroup_SPIFI = 70,                  /*!< Group number for SPIFI status codes. */
    kStatusGroup_MMDC = 71,                   /*!< Group number for MMDC status codes. */
    kStatusGroup_MICFIL = 72,                 /*!< Group number for MIC status codes. */
    kStatusGroup_SDMA = 73,                   /*!< Group number for SDMA status codes. */
    kStatusGroup_ICS = 74,                    /*!< Group number for ICS status codes. */
    kStatusGroup_SPDIF = 75,                  /*!< Group number for SPDIF status codes. */
    kStatusGroup_HASHCRYPT = 80,              /*!< Group number for HASHCRYPT status codes. */
    kStatusGroup_NOTIFIER = 98,               /*!< Group number for NOTIFIER status codes. */
    kStatusGroup_DebugConsole = 99,           /*!< Group number for debug console status codes. */
    kStatusGroup_ApplicationRangeStart = 100, /*!< Starting number for application groups. */
    kStatusGroup_SEMC = 101,                  /*!< Group number for SEMC status codes. */
};
        ...
        extern "C"
{
     ...
     * DisableGlobalIRQ().
     */
    static inline void EnableGlobalIRQ(uint32_t primask) { __set_PRIMASK(primask); }
    /*!
