...
#define FLASH_NONSECURE_ADDR(x) ((x) & 0xEFFFFFFFU)
#else
#define FLASH_NONSECURE_ADDR(x) (x)
#endif

#define FSPI1_FLASH_BASE_ADDR 0x28000000
#define FSPI1_FLASH_BASE_ADDR_ALIAS 0x02000000
#define FSPI2_FLASH_BASE_ADDR 0x04000000
#define FSPI2_FLASH_BASE_ADDR_ALIAS 0x22000000
...
#elif defined(RT1180_FRDM)
#define CONFIG_FLEXSPI1_OPTION0 0xC0000007
#define CONFIG_FLEXSPI1_OPTION1 0x00000000
#define CONFIG_FLEXSPI2_OPTION0 0xC0000005
#define CONFIG_FLEXSPI2_OPTION1 0x00000000
...
int Init (unsigned long adr, unsigned long clk, unsigned long fnc) {
    ...
    if (FSPI1_FLASH_BASE_ADDR == FLASH_NONSECURE_ADDR(adr)
#ifdef MIMXRT1189_cm33_SERIES
	|| FSPI1_FLASH_BASE_ADDR_ALIAS == FLASH_NONSECURE_ADDR(adr)
#endif
       )
    {
        fspi_instance = 1;
    ...
    else if (FSPI2_FLASH_BASE_ADDR == FLASH_NONSECURE_ADDR(adr)
#ifdef MIMXRT1189_cm33_SERIES
	|| FSPI2_FLASH_BASE_ADDR_ALIAS == FLASH_NONSECURE_ADDR(adr)
#endif
	)
    {
        fspi_instance = 2;
